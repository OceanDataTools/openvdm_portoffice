...
Router::any('api/dashboardData/getLowerings/(:any)', 'Controllers\Api\DashboardData@getLowerings');
Router::any('api/dashboardData/getLatestLowering/(:any)', 'Controllers\Api\DashboardData@getLatestLowering');
