$(function () {
    ...
    function initMapObject(placeholderID, objectListID) {
        ...
        greenIcon = new L.Icon({
            iconUrl: siteRoot + 'bower_components/leaflet-color-markers/img/marker-icon-green.png',
            shadowUrl: siteRoot + 'bower_components/leaflet/dist/images/marker-shadow.png',
            iconSize: [25, 41],
            iconAnchor: [12, 41],
            popupAnchor: [1, -34],
            shadowSize: [41, 41]
        ...
        redIcon = new L.Icon({
            iconUrl: siteRoot + 'bower_components/leaflet-color-markers/img/marker-icon-red.png',
            shadowUrl: siteRoot + 'bower_components/leaflet/dist/images/marker-shadow.png',
            iconSize: [25, 41],
            iconAnchor: [12, 41],
            popupAnchor: [1, -34],
